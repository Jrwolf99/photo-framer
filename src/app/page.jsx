...
export default function HomePage() {
  ...
  const [backgroundHeight, setBackgroundHeight] = useState(600);
  ...
  const loadDocument = (document) => {
    ...
    setBackgroundWidth(document.backgroundWidth || 800);
    setBackgroundHeight(document.backgroundHeight || 600);
  ...
  const loadConfiguration = (config) => {
    ...
    setBackgroundWidth(config.backgroundWidth || 800);
    setBackgroundHeight(config.backgroundHeight || 600);
                    ...
                    <div className="flex items-center gap-2">
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          if (!isNaN(val)) {
                            setBackgroundWidth(
                              Math.max(200, Math.min(3000, val)),
                            );
                          }
                        }}
                      ...
                      <button
                        onClick={() => setBackgroundWidth(800)}
                ...
                <div>
                  <div className="mb-1 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs text-gray-500">px</span>
                      <button
                        onClick={() => setBackgroundHeight(600)}
                        className="rounded bg-gray-300 px-1.5 py-0.5 text-xs font-medium text-gray-700 transition-colors hover:bg-gray-400"
                      >
                        Reset
                      </button>
                  ...
                  <input
                    ...
                    value={backgroundHeight}
                    onChange={(e) =>
                      setBackgroundHeight(Number(e.target.value))
                    }
                    min="200"
                    max="3000"
                    step="10"
                      ...
                      <div className="flex items-center gap-2">
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            if (!isNaN(val)) {
                              setImageHeight(
                                Math.max(100, Math.min(2000, val)),
                              );
                            }
                          }}
                          className="w-16 rounded border border-gray-300 px-2 py-0.5 text-xs text-gray-700 focus:border-blue-500 focus:outline-none"
                        ...
                        <div className="flex items-center gap-2">
                          <input
                            ...
                            onChange={(e) => {
                              const val = Number(e.target.value);
                              if (!isNaN(val)) {
                                setFanSpacing(Math.max(0, Math.min(200, val)));
                              }
                            }}
                            className="w-16 rounded border border-gray-300 px-2 py-0.5 text-xs text-gray-700 focus:border-blue-500 focus:outline-none"
                          />
            ...
            {hasImages && (
              <div className="space-y-2 pt-4">
                <div className="flex gap-2">
                  ...
                  <DownloadButton cardRef={cardRef} title="image-card" />
                </div>
              </div>
            )}
          </div>
